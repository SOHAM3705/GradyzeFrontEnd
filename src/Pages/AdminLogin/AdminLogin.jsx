  ...
  useEffect(() => {
    ...
    const handleCredentialResponse = async (response) => {
      try {
        ...
        console.log("✅ Google ID Token:", response.credential); // This is the Google ID token sent from frontend
        console.log("✅ JWT Token:", token); // This is the JWT token received from backend

        // Store the JWT token (generated by the backend) in sessionStorage
        sessionStorage.setItem("token", token); // This is the JWT token
