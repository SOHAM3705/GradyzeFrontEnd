...
const SubscriptionPlan = () => {
  return (
    <div className="min-h-screen bg-blue-50 flex flex-col items-center p-8">
      ...
      <div className="pricing-container flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
        {/* Plan Component */}
        {[
          {
            title: "BASIC",
          ...
          >
            ...
            <button
              className={`mt-auto w-full py-3 px-6 bg-white text-blue-900 border border-blue-900 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:bg-blue-900 hover:text-white active:scale-95 shadow-md`}
            >
              Buy Now
            </button>
          </div>
