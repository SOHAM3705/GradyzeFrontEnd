...
const ProfileDetails = ({ profileImage, handleImageChange }) => {
  return (
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg">
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <h2 className="text-xl font-semibold border-b pb-2 mb-4">Security</h2>
          <div className="mb-4">
            <label className="block text-gray-700 font-medium">
              Current Password
            </label>
...
const ProfileSettings = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      />
      <ChangePassword handleSubmit={handleSubmit} />
    </div>
  );
};
